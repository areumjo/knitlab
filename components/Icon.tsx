...
export const FillIcon = (props: SpecificIconComponentProps) => <Icon path="M7 3l10 10-7 7-7-7L13 3M4 13h12M18 17c0 1.1.9 2 2 2s2-.9 2-2c0-.8-1-2.2-2-3.5-1 1.3-2 2.7-2 3.5z" {...props} />;
